...
namespace StatsMasterDemo
{
	...
	public class FunctionListForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.dataGrid1.Size = new System.Drawing.Size(544, 245);
		...
		private void loadFunctions() {
            string FileName;
            string FilePath = Utils.ReadDemoPath();
            if (Directory.Exists(FilePath))
            {
                FileName = FilePath + @"Data\List_Functions.txt";
            }
            else
            {
                FileName = @".\Data\List_Functions.txt";
            }
