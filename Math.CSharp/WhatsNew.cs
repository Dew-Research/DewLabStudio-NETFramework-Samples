...
namespace MtxVecDemo {
	...
	public class WhatsNewForm : System.Windows.Forms.Form {
		...
		private void WhatsNewForm_Load(object sender, System.EventArgs e) {
            ...
            Add("List of new features in v6.2.0 (April 2024):");
            Add("");
            ...
            Add("Updated for Visual Studio 2022, v17.9.3");
            Add("Updated for TeeChart.NET release version v4.2024.3.15");
            Add("Updated Debugger Visualizers for Visual Studio 2022, v17.6 and newer");
            Add("Added support for .NET Core v7 and v8");
