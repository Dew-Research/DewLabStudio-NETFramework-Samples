...
{
	/// <summary>
	/// Summary description for AmpltRatiosForm.
	/// </summary>
	public class AmpltRatiosForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent() {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AmpltRatiosForm));
            ...
            // ChartButton
            // 
            this.ChartButton.Location = new System.Drawing.Point(119, 6);
            this.ChartButton.Name = "ChartButton";
            this.ChartButton.Size = new System.Drawing.Size(82, 23);
            ...
            this.SpectrumButton.Size = new System.Drawing.Size(89, 23);
            ...
            this.SpectrumAnalyzer1.Bands.TemplatesSerialization = resources.GetString("resource.TemplatesSerialization");
        ...
        "Frequency spectrum"};
            ...
            this.SpectrumChart1.Size = new System.Drawing.Size(914, 483);
            ...
            // 
            // 
            this.Series1.Marks.TailParams.Align = Steema.TeeChart.Styles.TailAlignment.Auto;
            ...
            // 
            // 
            this.Series2.Marks.TailParams.Align = Steema.TeeChart.Styles.TailAlignment.Auto;
            ...
            this.ChartEditor.Click += new System.EventHandler(this.ChartEditor_Click);
            // 
            // AmpltRatiosForm
            // 
            ...
            this.Name = "AmpltRatiosForm";
            this.Text = "OrderTrackingForm";
            this.Load += new System.EventHandler(this.AmpltRatiosForm_Load);
		...
		private void SpectrumChart1_OnAfterMarkPeak(object Sender) {
			if (SpectrumAnalyzer1.Peaks.List.Count == 1) {
				SpectrumAnalyzer1.ScaleFactor = SpectrumAnalyzer1.ScaleFactor/SpectrumAnalyzer1.Peaks[0].Amplt;
        ...
        private void AmpltRatiosForm_Load(object sender, EventArgs e)
        {
            richTextBox1.Clear();
            Add("In the example below you can examine the amplitude "
                + "ratios between different frequency peaks. The first "
                + "peak clicked will become 1. Double click to clear all peaks.");
        }

        private void SpectrumButton_Click(object sender, EventArgs e)
        {
            //byte[] test = null;
            //SpectrumAnalyzer1.Bands.Templates.GetObjectToByteArray(ref test);
            //SpectrumAnalyzer1.Bands.Templates.Clear();
            //SpectrumAnalyzer1.Bands.Templates.SetObjectFromByteArray(test);

            if (SpectrumAnalyzer1.Bands.Templates.Count > 0)
            {
                SpectrumAnalyzer1.Bands.TemplateIndex = SpectrumAnalyzer1.Bands.Templates.Count - 1;
            }
        ...
        private void ChartEditor_Click(object sender, EventArgs e)
        {
